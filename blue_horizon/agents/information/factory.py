                        ...
                        [
                            SystemMessage(
                                content=(
                                    ...
                                    "string.\n\n"
                                    "Booking rules:\n"
                                    "- 'no booking', 'walk-in', 'no reservation': "
                                    "booking_required = False.\n"
                                    "- 'booking required is fine', 'fine with "
                                    "booking': booking_required = null "
                                    "(user accepts it, does not require it).\n"
                                    "- Multi-item: False only if ALL items carry "
                                    "a no-booking signal; null if mixed.\n\n"
                                    "Notice rules:\n"
                                    "- 'can only give X hours notice': "
                                    "max_notice_hours = X.\n"
                                    "- Shared cap across items: "
                                    "max_notice_hours = that cap.\n"
                                    "- Different per-item notice constraints: "
                                    "max_notice_hours = largest value.\n"
                                    "- Do not infer from walk-in/no-booking.\n\n"
                                    "Price rules:\n"
                                    "- 'under $X', 'both under $X', 'budget up "
                                    "to $X', 'max $X': max_price = X, "
                                    "min_price = null.\n"
                                    "- Multiple items with different per-item "
                                    "prices: max_price = largest value.\n"
                                    "- 'at least $X' / 'starting from $X': "
                                    "min_price = X only.\n"
                                    "- No price stated: both null.\n\n"
